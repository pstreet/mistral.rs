...
using fmha_block_tile = ck_tile::sequence<128, 64, 32, 256, 32, 256>;
...
using trait = fmha_fwd_traits_<256, FmhaFwdBf16, false,128, 64, 32, 256, 32, 256, true,
                        ck_tile::BlockFmhaPipelineEnum::QRKSVS, false, fmha_mask, ck_tile::BlockAttentionBiasEnum::NO_BIAS, true, false, ck_tile::BlockAttentionQuantScaleEnum::NO_SCALE, true, true, false, false, false, false, false>;
...
float fmha_fwd_<trait, ck_tile::gfx115_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d256_bf16_batch_b128x64x32x256x32x256_r8x1x1_r8x1x1_w16x16x16_w16x16x16_qr_vr_pssk_nlogits_nbias_nmask_lse_ndropout_nskip_nqscale_ntrload_nsink" << std::flush;
