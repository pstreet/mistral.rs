...
template <int mmq_x>
static void instantiate_mmq_q5_1(float *tmp_fixup, const mmq_args &args,
                                 cudaStream_t stream, int cc, int nsm,
                                 size_t smpbo, int warp_size_host) {

  const int mmq_y = get_mmq_y_host(cc);
  const int nwarps = 256 / warp_size_host;
  const int nbytes_shared = mmq_get_nbytes_shared<GGML_TYPE_Q5_1>(
...
static void launch_mmq_case_q5_1(float *tmp_fixup, const mmq_args &args,
                                 cudaStream_t stream, int cc, int nsm,
                                 size_t smpbo, int warp_size_host) {
  ...
  for (int mmq_x = 8; mmq_x <= mmq_x_max && ntiles_x_best > 1; mmq_x += 8) {
    ...
    if (mmq_x % granularity != 0)
      continue;
    const size_t nbs = mmq_get_nbytes_shared<GGML_TYPE_Q5_1>(
        mmq_x, mmq_y, cc, warp_size_host, nwarps);
    if (nbs > smpbo)
      continue;
  ...
  switch (mmq_x_best) {
  case 8:
    instantiate_mmq_q5_1<8>(tmp_fixup, args, stream, cc, nsm, smpbo,
                            warp_size_host);
    break;
  case 16:
    instantiate_mmq_q5_1<16>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 24:
    instantiate_mmq_q5_1<24>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 32:
    instantiate_mmq_q5_1<32>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 40:
    instantiate_mmq_q5_1<40>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 48:
    instantiate_mmq_q5_1<48>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 56:
    instantiate_mmq_q5_1<56>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 64:
    instantiate_mmq_q5_1<64>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 72:
    instantiate_mmq_q5_1<72>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 80:
    instantiate_mmq_q5_1<80>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 88:
    instantiate_mmq_q5_1<88>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 96:
    instantiate_mmq_q5_1<96>(tmp_fixup, args, stream, cc, nsm, smpbo,
                             warp_size_host);
    break;
  case 104:
    instantiate_mmq_q5_1<104>(tmp_fixup, args, stream, cc, nsm, smpbo,
                              warp_size_host);
    break;
  case 112:
    instantiate_mmq_q5_1<112>(tmp_fixup, args, stream, cc, nsm, smpbo,
                              warp_size_host);
    break;
  case 120:
    instantiate_mmq_q5_1<120>(tmp_fixup, args, stream, cc, nsm, smpbo,
                              warp_size_host);
    break;
  case 128:
    instantiate_mmq_q5_1<128>(tmp_fixup, args, stream, cc, nsm, smpbo,
                              warp_size_host);
    break;
  default:
    break;
...
extern "C" void launch_mmq_gguf_q5_1(void *tmp_fixup_ptr, const void *x,
  ...
  launch_mmq_case_q5_1((float *)tmp_fixup_ptr, args, (cudaStream_t)stream, cc,
                       nsm, smpbo, warp_size_host);
}

DEFINE_MMQ_MOE_LAUNCHER(q5_1, GGML_TYPE_Q5_1, launch_mmq_case_q5_1)
